...
var FancyParallelCoordinatesD3 = /*#__PURE__*/function () {
  function FancyParallelCoordinatesD3(el, props) {
    ...
    d3__WEBPACK_IMPORTED_MODULE_0__["select"](el).selectAll("*").remove();
  ...
  _createClass(FancyParallelCoordinatesD3, [{
    ...
    value: function createPCP(props, svg) {
      ...
      }).style("opacity", 0.5); // Draw threshold line

      var thresholdY = scales[dimensions[0]](1.0);
      svg.append("line").attr("y1", thresholdY).attr("y2", thresholdY).attr("x1", leftBox).attr("x2", rightBox).attr("stroke", "red").attr("stroke-width", "2px").attr("stroke-dasharray", "5,5"); // Draw the axes
      ...
      svg.selectAll("text").style("fill", "black").attr("font-size", props.fontSize); // brushing

      axes.each(function (d) {
        d3__WEBPACK_IMPORTED_MODULE_0__["select"](this).call(scales[d].brush = d3__WEBPACK_IMPORTED_MODULE_0__["brushY"]().extent([[-10, 0], [10, height]]).on("start", brush).on("brush", brush).on("end", brushend));
      ...
      function brush(_ref4, key) {
        ...
        foreground.each(function (d) {
          ...
          if (active) {
            ...
            selected.push(d.id); //props.setProps({selection: this.selection, redraw: false});
          }
        });
      }
...
//# sourceMappingURL=1577629-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIxNTc3NjI5LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==