...
var FancyParallelCoordinatesD3 = /*#__PURE__*/function () {
  function FancyParallelCoordinatesD3(el, props) {
    ...
    this.svg = this.parent.append('svg').attr('width', this.width + this.margin.left + this.margin.right).attr('height', this.height + this.margin.top + this.margin.bottom).append('g').attr('transform', 'translate(' + this.margin.left + ',' + this.margin.top + ')');
  ...
  _createClass(FancyParallelCoordinatesD3, [{
    ...
    key: "createPCP",
    value: function createPCP(props) {
      ...
      for (var i = 0; i < dimensions.length; i++) {
        scales[dimensions[i]] = d3__WEBPACK_IMPORTED_MODULE_0__["scaleLinear"]().domain(props.data[i].range).range([this.height, 0]);
      } // Create x-axes to lay out the y-axes


      var xScale = d3__WEBPACK_IMPORTED_MODULE_0__["scalePoint"]().range([0, this.width]).padding(1).domain(dimensions); // draw lines
      ...
      axes.each(function (d) {
        d3__WEBPACK_IMPORTED_MODULE_0__["select"](this).call(scales[d].brush = d3__WEBPACK_IMPORTED_MODULE_0__["brushY"]().extent([[-10, 0], [10, this.height]]).on("start", brush).on("brush", brush).on("end", brush));
...
//# sourceMappingURL=5b5f086-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI1YjVmMDg2LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==