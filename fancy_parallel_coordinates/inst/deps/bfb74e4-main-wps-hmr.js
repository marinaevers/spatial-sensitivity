  ...
  function FancyParallelCoordinatesD3(el, props) {
    ...
    function brush(_ref2, key) {
      ...
      foreground.each(function (d) {
        ...
        d3__WEBPACK_IMPORTED_MODULE_0__["select"](this).style("stroke", active ? "green" : "blue");
    ...
    props.data.map(function (d) {
      for (var _i2 = 0; _i2 < d.values.length; _i2++) {
        if (values.length < d.values.length) {
          values.push({});
          values[_i2][d.label] = d.values[_i2];
        } else {
          values[_i2][d.label] = d.values[_i2];
        }
      }
    });
    var foreground = this.svg.append("g").selectAll("path").data(values).enter().append("path").attr("d", path).style("fill", "none").style("stroke", "#005454").style("opacity", 0.5); // Returns the path for a given data point.
...
//# sourceMappingURL=bfb74e4-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJiZmI3NGU0LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==