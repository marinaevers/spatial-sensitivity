...
var FancyParallelCoordinatesD3 = /*#__PURE__*/function () {
  function FancyParallelCoordinatesD3(el, props) {
    ...
    this.svg = parent.append('svg').attr('width', width + margin.left + margin.right).attr('height', height + margin.top + margin.bottom).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
    ...
    value: function createPCP(props, svg) {
      ...
      var margin = {
        ...
        left: 0
          ...
          width = props.dataWidth - margin.left - margin.right,
          height = props.height - margin.top - margin.bottom; // Create axes for data
      ...
      }).style("opacity", 0.2); // Draw the axes
      ...
      svg.selectAll("text").style("fill", "purple").style("font-size", props.fontSize); // brushing
      ...
      function brush(_ref2, key) {
        ...
        foreground.each(function (d) {
          ...
          d3__WEBPACK_IMPORTED_MODULE_0__["select"](this).style("stroke", active ? "#005454" : "grey").style("opacity", active ? 0.5 : 0.2);
...
//# sourceMappingURL=eac5be9-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJlYWM1YmU5LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==