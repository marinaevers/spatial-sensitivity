...
#' @export
hgHorizonGraph <- function(id=NULL, bands=NULL, bgcolor=NULL, fontSize=NULL, height=NULL, legendOffset=NULL, names=NULL, numBrushes=NULL, numberHorizons=NULL, padding=NULL, redraw=NULL, selectedRanges=NULL, threshold=NULL, width=NULL, x=NULL, xLabel=NULL, y=NULL, yLabel=NULL) {
