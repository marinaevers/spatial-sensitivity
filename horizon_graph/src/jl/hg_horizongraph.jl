...
export hg_horizongraph

"""
    hg_horizongraph(;kwargs...)
...
"""
function hg_horizongraph(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("hg_horizongraph", "HorizonGraph", "horizon_graph", available_props, wild_props; kwargs...)
end
