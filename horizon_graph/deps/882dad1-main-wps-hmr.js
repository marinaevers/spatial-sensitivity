...
var HorizonGraphD3 = /*#__PURE__*/function () {
  function HorizonGraphD3(el, props) {
    ...
    this.width = width;
    this.height = height;
    d3__WEBPACK_IMPORTED_MODULE_0__["select"](el).selectAll("*").remove(); // Construct scales and axes
    ...
    if (props.numberHorizons < props.y.length) {
      this.bands = Math.max(2, Math.ceil(d3__WEBPACK_IMPORTED_MODULE_0__["max"](props.y.slice(this.numberHorizons).flat())));
    } else {
      this.bands = 0;
    ...
    var svg = this.svg;
    svg.call(d3__WEBPACK_IMPORTED_MODULE_0__["zoom"]().on("zoom", function (d) {
  ...
  _createClass(HorizonGraphD3, [{
    ...
    value: function summaryPlot(props) {
      ...
      var yScale = d3__WEBPACK_IMPORTED_MODULE_0__["scaleLinear"]([0, this.bands], [this.size * this.bands, props.padding]);
      var area = d3__WEBPACK_IMPORTED_MODULE_0__["area"]().curve(this.curve).x(function (i) {
      ...
      var yAxis = d3__WEBPACK_IMPORTED_MODULE_0__["axisLeft"](yScale).ticks(Math.max(2, this.bands + 1));
...
//# sourceMappingURL=882dad1-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI4ODJkYWQxLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==