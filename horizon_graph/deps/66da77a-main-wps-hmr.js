...
var HorizonGraphD3 = /*#__PURE__*/function () {
  function HorizonGraphD3(el, props) {
    ...
    var size = (height - margin.top - margin.bottom) / (this.numberHorizons + bands);
    this.size = size;
    this.bands = bands;
    ...
    function newBrush() {
      var brush = d3__WEBPACK_IMPORTED_MODULE_0__["brushX"]().extent([[margin.left, -2], [width - margin.right, height + 2]]).on("start", brushstart).on("brush", brushed).on("end", brushend);
      brushes.push({
        id: brushes.length,
        brush: brush
      });
    ...
    function drawBrushes() {
      ...
      d3__WEBPACK_IMPORTED_MODULE_0__["select"]("rect.selection").attr("fill", "#dbdbdb").attr("stroke", "black").attr("stroke-width", "3px");
    }
  ...
  _createClass(HorizonGraphD3, [{
    ...
    value: function summaryPlot(props) {
      ...
      var yScale = d3__WEBPACK_IMPORTED_MODULE_0__["scaleLinear"](this.yDomain, [this.size * this.bands, props.padding]);
      var area = d3__WEBPACK_IMPORTED_MODULE_0__["area"]().curve(this.curve).x(function (i) {
...
//# sourceMappingURL=66da77a-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI2NmRhNzdhLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==