...
var HorizonGraphD3 = /*#__PURE__*/function () {
  function HorizonGraphD3(el, props) {
    ...
    this.yDomain = [0, yMax];
    this.bands = Math.ceil(d3__WEBPACK_IMPORTED_MODULE_0__["max"](props.y.slice(this.numberHorizons).flat())); // number of bands for lowest plot
  ...
  _createClass(HorizonGraphD3, [{
    ...
    value: function summaryPlot(props) {
      ...
      .attr("x", -(this.size * (this.bands + 1)) / 2).text("text-anchor", "middle").attr("font-size", props.fontSize).text(props.yLabel).attr("transform", "rotate(-90)");
      ...
      var legend = summaryPlot.append("g").attr("transform", 'translate(' + (this.width - this.margin.right + 20) + ',' + 40 + ')');
      legend.selectAll("mylines").data(d3__WEBPACK_IMPORTED_MODULE_0__["group"](d3__WEBPACK_IMPORTED_MODULE_0__["range"](props.names.length - props.numberHorizons), function (i) {
        return props.names.slice(props.numberHorizons)[i];
      ...
      legend.selectAll("mytext").data(d3__WEBPACK_IMPORTED_MODULE_0__["group"](d3__WEBPACK_IMPORTED_MODULE_0__["range"](props.names.length - props.numberHorizons), function (i) {
        return props.names.slice(props.numberHorizons)[i];
...
//# sourceMappingURL=bc71c92-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJiYzcxYzkyLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==